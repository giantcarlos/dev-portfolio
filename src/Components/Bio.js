  ...
  return (
    <Fade>
      <div className="bio">
        ...
        <p>Manila-born, Texas-based front-end web developer specializing in UI design and web accessibility. Skilled in JavaScript, React, Redux, Ruby, Rails, HTML, and CSS, with a strong commitment to delivering intuitive and inclusive user experiences. Fully up to date with WCAG 2.2 standards, ensuring accessibility is prioritized in every project.</p>
