  ...
  return (
    <>
      ...
      <div className="bio">
        ...
        <p>Beyond the world of code, I am a former touring musician turned local Dallas area DJ. A dedicated long-distance runner with four Dallas Marathon finishes. During downtime, I indulge in Dungeons & Dragons and Magic: The Gathering, as I value the creativity and social connections these games foster.</p>
      </div>
