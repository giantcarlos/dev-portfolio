...
function Bio() {
  return (
    <div className="bio">
      ...
      <p>Manila-born, Texas-based software engineer specializing in front-end web development, UI design, and web accessibility. Experienced in JavaScript, React, Redux, Ruby, Rails, HTML, CSS, and Figma, with a strong commitment to crafting intuitive and inclusive user experiences. Up to date with current WCAG standards, ensuring accessibility in every project.</p>
